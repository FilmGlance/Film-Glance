...
/**
 * FloatingParticles — Three.js WebGL orbital particle field.
 *
 * Adapted from prompt2.txt. Differences from the source:
 *   - Tailwind `w-full h-full` swapped for inline `width/height: 100%`
 *     (this codebase is inline-styled, no Tailwind)
 *   - Brand-aligned default colors (Film Glance gold + warm pale gold)
 *   - prefers-reduced-motion early-return for accessibility
 */
